export const quoteSections = [
  {
    ...
    teaser: "Ik woon in het centrum van Tielt, ik woon hier graag maar de formule van cohousen biedt me meer. Het is voor mij belangrijk om in verbinding te staan met mensen, om betrokkenheid, openheid en inspiratie te ervaren. Zeker nu mijn kinderen de deur uit zijn. Ik geniet van het meeleven en samenleven met anderen, jong en oud, met respect voor ieders privéleven. Dat ik de mensen om me heen ken, biedt me een gevoel van geborgenheid.",
    paragraphs: [
      {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      {
        text: "Naar de toekomst toe vinden wij het heel praktisch dat we aan het station zitten. Als de kinderen wensen verder te studeren geraken ze met het openbaar vervoer vlot in Gent, Brugge, Kortrijk, Brussel,…"
      },
      {
        text: "Het lijkt ons ook een leuke plaats om oud te worden. Indien we onze woning dan te groot vinden kunnen we misschien uitkijken of er een appartement vrij komt op het domein, zo zouden we niet van plaats moeten veranderen."
      }
    ],
    linkText: "Lees het verhaal",
    imageSource: "/assets/img/verhalen/gezinnen/f-en-e-portret.jpg",
    imageAlt: "Frederik (34), Elke (31) en hun kinderen: Maya (8) en Liam (3)."
  }
];
