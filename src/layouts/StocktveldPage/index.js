...
const StocktveldPage = (props) => {
  const quoteSections = [
    ...
    },
    {
      ...
      paragraphs: [
        { info: "Ellie (38), Wannes (37) en twee kinderen: Ferre (8) en Fin (6)" },
  ...
  const QuoteSections = quoteSections.map((quoteSection, index) => (
