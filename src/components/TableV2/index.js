  ...
  constructor(props) {
    ...
    this.state = {
      myTableData: [
        ...
        { lot: 30, type: 'Appartement +2', status: 'Bekijk details', unit: 66 },
        { lot: 31, type: 'Appartement +2', status: 'Bekijk details', unit: 67 },
        { lot: 32, type: 'Appartement +2', status: 'Bekijk details', unit: 102 },
        { lot: 33, type: 'Appartement +3', status: 'TE LAAT', unit: 99 },
        { lot: 34, type: 'Appartement +3', status: 'Bekijk details', unit: 91 },
        { lot: 35, type: 'Duplex +1 & +2', status: 'Bekijk details', unit: 77 },
        { lot: 36, type: 'Duplex +1 & +2', status: 'Gereserveerd', unit: 97 },
        { lot: 37, type: 'Duplex +1 & +2', status: 'TE LAAT', unit: 125 },
      ],
    };
  }
